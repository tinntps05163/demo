                ...
                if (mssv1.length() > 0) {
                    try {
                        ...
                        if (dem == 1) {
                            ...
                            JOptionPane.showMessageDialog(jp, "Trong Database khong co sinh vien nay!");
                            txttimkiem.setText("");
...
//                            
                                ...
                                if (txtidsv.getText().matches(s)) {
                                    ...
                                    JOptionPane.showMessageDialog(jp, "Sai kieu, MSSV co dang: PSxxxxx voi x tu 0->9");
                                    txtidsv.setText("");
                                    txtidsv.requestFocus();
                                }
                            } else {
